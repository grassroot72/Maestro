/*
 * Copyright (C) skywind3000@163.com, 2015
 * feature:
 ...
 * license: MIT license
 */
#ifndef _MEMCPY_SSE2_H_
#define _MEMCPY_SSE2_H_
 ...
 */
static INLINE void memcpy_sse2_16(void *dst,
                                  const void *src)
{
...
static INLINE void memcpy_sse2_32(void *dst,
                                  const void *src)
{
  __m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
...
static INLINE void memcpy_sse2_64(void *dst,
                                  const void *src)
{
  __m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
  __m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
...
static INLINE void memcpy_sse2_128(void *dst,
                                   const void *src)
{
  __m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
  __m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
 ...
 */
static INLINE void *memcpy_tiny(void *dst,
                                const void *src,
                                size_t size)
{
 ...
 * main routine
 */
static void* memcpy_fast(void *destination,
                         const void *source,
                         size_t size)
{
